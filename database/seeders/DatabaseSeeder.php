            ...
            'Identidad' => [
                ...
                'guides' => [
                    [
                        ...
                        'steps' => [
                            ['text' => 'Agenda una cita en el portal de RENIEC (opcional, pero evita colas) o acércate directo en horario de atención.', 'link' => 'https://www.reniec.gob.pe', 'link_label' => 'Agendar cita en RENIEC', 'image' => null],
                            ['text' => 'Paga la tasa del trámite regular en el banco o agente autorizado.', 'link' => null, 'link_label' => null, 'image' => null],
                            ['text' => 'Preséntate con tu DNI anterior y el voucher de pago; te toman una nueva foto y huellas.', 'link' => null, 'link_label' => null, 'image' => null],
                            ['text' => 'Recibe tu nuevo DNI en el momento, o elige entrega a domicilio pagando el costo adicional.', 'link' => null, 'link_label' => null, 'image' => null],
                        ],
                    ],
                    [
                        ...
                        'steps' => [
                            ['text' => 'Verifica dónde está registrada la partida: Municipalidad donde naciste, o RENIEC si ya está digitalizada.', 'link' => null, 'link_label' => null, 'image' => null],
                            ['text' => 'Si está en RENIEC, solicítala en línea desde su portal o en cualquier oficina a nivel nacional.', 'link' => 'https://www.reniec.gob.pe', 'link_label' => 'Solicitar en RENIEC', 'image' => null],
                            ['text' => 'Si está solo en la Municipalidad, acércate a la oficina de Registro Civil con tu DNI y los datos de la persona.', 'link' => null, 'link_label' => null, 'image' => null],
                            ['text' => 'Paga la tasa correspondiente y recoge la partida (original o certificada según lo que pediste).', 'link' => null, 'link_label' => null, 'image' => null],
                        ],
                    ],
                ],
            ],
            'Vehículos' => [
                ...
                'guides' => [
                    [
                        ...
                        'steps' => [
                            ['text' => 'Sácate el certificado médico de aptitud psicosomática en un centro autorizado.', 'link' => null, 'link_label' => null, 'image' => null],
                            ['text' => 'Matricúlate en una escuela de conductores autorizada y lleva el curso teórico-práctico de tu categoría.', 'link' => null, 'link_label' => null, 'image' => null],
                            ['text' => 'Rinde y aprueba el examen de conocimientos y el examen de manejo de la escuela.', 'link' => null, 'link_label' => null, 'image' => null],
                            ['text' => 'Con todo aprobado, tramita la emisión de la licencia ante el MTC o la entidad autorizada en la región.', 'link' => null, 'link_label' => null, 'image' => null],
                        ],
                    ],
                ],
            ],
            'Municipal' => [
                ...
                'guides' => [
                    [
                        ...
                        'steps' => [
                            ['text' => 'Reúne los requisitos: DNI o RUC, croquis del local y declaración jurada de condiciones de seguridad.', 'link' => null, 'link_label' => null, 'image' => null],
                            ['text' => 'Presenta la solicitud en la Municipalidad Provincial (muchas veces disponible en línea) junto con el pago de la tasa.', 'link' => null, 'link_label' => null, 'image' => null],
                            ['text' => 'Espera la inspección del local por parte de la Municipalidad.', 'link' => null, 'link_label' => null, 'image' => null],
                            ['text' => 'Recoge tu licencia de funcionamiento una vez aprobada la inspección.', 'link' => null, 'link_label' => null, 'image' => null],
                        ],
                    ],
                ],
            ],
